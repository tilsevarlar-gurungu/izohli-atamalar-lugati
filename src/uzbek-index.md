...
- **Qalin** atamalar bosh yoki ona atamani anglatadi.
- *Yotiq* atamalar aloqali atamalarni anglatadi.
- Oddiy uslubdagi (qalin ham emas, yotiq ham emas) atamalar bola darajasidagi atamalarni anglatadi.

## A
- [**Alxorazma**](../terms/algorithm.md) - Algorithm - Алгоритм
- [**Andaza**](../terms/class.md) - Class - Класс
...
## Q
- [**Qaytalagich**](../terms/iterator.md) - Iterator - Итератор
    * [*Aylangich*](../terms/loop.md)
- [**Qobiliyat**](../terms/method.md) - Method - Метод
    * [**Andaza**](../terms/class.md)
    * *[Topshiriq](../terms/function.md)*
- [**Qolip**](../terms/pattern.md) - Pattern - Шаблон
